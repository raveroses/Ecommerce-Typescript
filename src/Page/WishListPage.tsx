...
const WishListPage = () => {
  ...
  const mappProduct = wishList.wishLitter.map((product, index) => {
    return (
      <div
        className="group bg-gray-100 w-full md:w-[250px] shadow-xl md:p-[10px] rounded-xl cursor-pointer mb-[20px] "
        key={index}
      >
  ...
  return (
    <div className="font-Afacad ">
      <div
        className={`grid grid-cols-2 md:grid-cols-5 gap-[10px] md:gap-[20px] my-[50px] mx-2`}
      >
